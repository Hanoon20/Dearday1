(function(){
  ...
  var portfolioItems = [
    ...
    {cat:"wedding", tag:"Wedding", title:"Olive-promise", desc:"A quiet, cinematic invitation to our forever.", url:"https://olive-promise.dearday.lk/", image:""},
    {cat:"wedding", tag:"Wedding", title:"Eventa-galaxy", desc:"Traditional details woven into a modern layout.", url:"https://eventa-galaxy.dearday.lk/", image:""},
  ...
  if(faqList){
    var faqs = [
      ...
      ["Can I add background music?", "Yes, background music can be added to Signature and Royal invitations to set the mood as guests open the link."],
      ["Can guests RSVP through the invitation?", "Yes, WhatsApp RSVP and contact options are available on our Signature and Royal packages."],
