(function(){
  ...
  var portfolioItems = [
    ...
    {cat:"wedding", tag:"Wedding", title:"Aqeel & Hana",desc:"Traditional details woven into a modern layout.",url:"https://aqeel-hana.netlify.app/?preview=true", image:""},
  ...
  function buildPortfolioCard(item, i){
    ...
    var autoPreview = (!item.image && item.url) ? ("https://image.thum.io/get/width/700/crop/500/noanimate/https://aqeel-hana.netlify.app/?preview=true" + item.url) : "";
